...
(function() {
    ...
    settings.prototype.songIntervalMessages = [
      {
        ...
        interval: 9,
        offset: 0,
        msg: "/em: Entre no nosso grupo do facebook e fique por dentro de todas as nossas atualizações: https://www.facebook.com/groups/plugdjteambrasil/"
      }
    ];
  ...
  pupOnline = function() {
    return API.sendChat("/me: TBRbot Online! v 2.0");
  };
  ...
  sourceCommand = (function(_super) {
    ...
    sourceCommand.prototype.functionality = function() {
      var msg;
      msg = ' BOT criado por Backus e editado por Notturno para a Team Brasil ';
      return API.sendChat(msg);
    };
  ...
  downloadCommand = (function(_super) {
    ...
    downloadCommand.prototype.functionality = function() {
      var msg;
      msg = "  Participe do grupo! https://www.facebook.com/groups/plugdjteambrasil/ ";
      msg += "= ";
      msg += "= ";
      return API.sendChat(msg);
    };
